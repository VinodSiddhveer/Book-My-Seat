...
import com.BookMySeat.beans.OrderHistory;
import com.BookMySeat.beans.Seat;
import com.BookMySeat.service.CustomerDao;
import com.BookMySeat.service.MovieDetailsDao;
...
//	update Details
	...
	public String saveMovie(@RequestBody MovieDetails mh) {
		dao1.saveMovie(mh) ;
		return "sucesfully saved " ;
	}
